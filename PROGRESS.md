...
|---|---|---|---|---|---|---|---|---|
| `PY-FND-010` | [Python syntax and execution](CURRICULUM.md#py-fnd-010) | Core | Absent | Not started | — | — | — | — |
...
| `PY-CON-010` | [Concurrency, parallelism, scheduling, and the GIL model](CURRICULUM.md#py-con-010) | Core | Absent | Not started | — | — | — | — |
...
| `PY-CON-060` | [Asyncio event loop, coroutines, tasks, and context](CURRICULUM.md#py-con-060) | Core | Absent | Not started | — | — | — | — |
