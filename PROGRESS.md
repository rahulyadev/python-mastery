...
| `PY-FND-060` | [Control flow and structural pattern matching](CURRICULUM.md#py-fnd-060) | Core | Approved | Not started | — | — | — | [Unit note](units/foundations/PY-FND-060-control-flow-and-structural-pattern-matching/README.md) |
...
| `PY-BLT-030` | [Bytes, bytearray, memoryview, and the buffer model](CURRICULUM.md#py-blt-030) | Professional | Draft | Not started | — | — | — | [Unit note](units/built-in-types/PY-BLT-030-bytes-bytearray-memoryview-and-the-buffer-model/README.md) |
